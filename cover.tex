...
\begin{document}
    \begin{bookcover}
        ...
        \color{black}\transparent{0.1}Elementary Analytic Number Theory}}
        \bookcovercomponent{center}{front lower third}{
        \resizebox*{\partwidth-5mm}{\partheight-5mm}{%
        \color{white}\transparent{0.1}Masum Billal}}
        \bookcovercomponent{center}{front}{
        \resizebox{90mm}{!}{\color{black}\bfseries \MakeUppercase{Elementary Analytic Number Theory}}}
        \bookcovercomponent{normal}{back text area}{\color{black}{\MakeUppercase{Elementary Analytic Number Theory}}}
