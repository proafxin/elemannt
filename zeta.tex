...
\begin{document}
	\section{Dirichlet Series and Dirichlet Product}\label{sec:zeta}
	...
	The coefficients $h(n)$ of $\mathfrak{D}_{h}(s)$ is determined as follows.
		\begin{align*}
			h(n)
				& = \sum_{de=n}f(d)g(e)
		\end{align*}
	After a little observation, it seems quite obvious that this is indeed correct. In fact, this is what we call the Dirichlet product today.
