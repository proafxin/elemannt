...
\usepackage[bibstyle=philosophy-modern,citestyle=verbose-trad1,backend=biber,autopunct,sortcites,dashed,datamodel=ext-eprint,doi,eprint,scauthors=true,volnumformat=strings,volumeformat=romansc,scauthorsbib,scauthorscite]{biblatex}
