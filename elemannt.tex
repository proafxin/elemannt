...
%\titleformat{\section}[runin]{}{\thesection}{}{}
\titleformat{\section}[runin]{\large\normalfont\bfseries}{}{0em}{{#1}.}
...
\begin{document}
	...
	\TitlePage [  ]
	{
		color = { main = purple!100!, back = gray!100 }
		, title     = \color{black}\centering\normalfont\Huge\bfseries\textit{Elementary Analytic Number Theory}
		, subtitle  =
		, author    = \color{black}\normalfont\bfseries\MakeUppercase{Masum\hspace{.2em} Billal}
		, date      = {}
		, logo      = {} %<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
	}
