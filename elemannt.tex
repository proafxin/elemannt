...
\usepackage[style=philosophy-verbose,backend=biber,sortcites=true,classical=true,scauthors=true, scauthorscite=true,scauthorsbib=true,volnumformat=strings,volumeformat=romansc,giveninits]{biblatex}
...
\else
	\setmainfont[FakeBold=1.5]{Old Standard}
	\setmathfont[FakeBold=1.5,BoldFont={XITSMath-Bold.otf}]{NewCMMath-Book.otf}
	...
	\newfontfamily{\custom}{ModernMT-Extended.otf}[FakeBold=1.5,ItalicFont=ModernMT-ExtendedItalic.otf,BoldFont=OldStandard-Bold.otf]
	\makeatletter
