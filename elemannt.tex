...
\ifxetex
	...
	%\setmathfont[range={up,},Scale=\scale,FakeStretch=\fakestretch,FakeBold=\fakemathbold]{CenturymodernTT-Regular.otf}
	...
	\setmathfont{CenturymodernTT-Regular.otf}[range={bb,frak,it/{num},up/{num},"00A7},Scale=\scale,FakeStretch=\fakestretch,FakeBold=\fakemathbold]
	%\setmathfont{OldStandard-Regular.otf}[range={"2260-"2267,"003C-"003E,"00A7,"226A-"226B},FakeBold=\fakemathbold,FakeStretch=1.05\fakestretch]
	%\setmathfont{ModernMT-ExtendedItalic-New.otf}[range={up/{greek,Greek},it/{greek,Greek},"003D},FakeStretch=\fakestretch,Scale=1.,FakeBold=\fakemathbold,]
	%\setmathfont{CenturymodernTT-Italic.otf}[range={up/{latin,Latin},it/{latin,Latin}},FakeBold=\fakemathbold,FakeStretch=\fakestretch]
	...
	\newfontfamily\intfont{Centurymodernitalic2.ttf}[FakeBold=0]% OldStandard-Italic.otf,latinmodern-math.otf,Erewhon-Math.otf
	\makeatletter
...
\titleformat{\chapter}[display]{\Huge}{}{1ex}{\centering\vspace{1ex}\ifthenelse{\value{chapter}>0}{\MakeUppercase}{}}[\vspace{1ex}]
...
\newtheorem{theorem}{\textit{\textbf{Theorem}}}
\theoremstyle{definition}
\newenvironment{definition}[1][]{\par\medskip\noindent \textbf{\textit{{\ifthenelse{\isempty{#1}}{Definition.}{#1.}}}} \rmfamily}{\medskip}
...
\fancypagestyle{fancy}{
	...
	\fancyhead[R]{\thepage}
	\fancyhead[CO]{\small Chapter \arabic{chapter},\hspace{.4em}\thesection\hspace{.1em}\nouppercase\rightmark}
}
