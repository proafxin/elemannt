...
\usepackage{hyperref}
\usepackage{relsize}
\hypersetup{colorlinks,citecolor=teal,linktocpage,linkcolor=cyan,pdfstartview=,pdfencoding=auto,}
...
\titleformat{\chapter}[display]{\bfseries\scshape\Huge}{}{1ex}{\centering\titlerule\vspace{1ex}$\S$\thechapter.\;}[\vspace{1ex}\titlerule]
