...
\usepackage{xifthen,fancyhdr,titlesec}
...
\titleformat{\chapter}[display]{\bfseries\scshape\Huge}{\filright}{1ex}{\centering\titlerule\vspace{1ex}\filleft}[\vspace{1ex}\titlerule]
\titleformat{\section}[display]{\bfseries\scshape\LARGE}{\filright}{1ex}{\centering\filleft$\S$\thesection\;}[\titlerule]
