...
\ifxetex
	...
	\setmathfont{CenturymodernTT-Regular.otf}[range={bb,frak,it/{num},up/{num},"00A7,"0028-"0029,},Scale=\scale,FakeStretch=\fakestretch,FakeBold=\fakemathbold]
...
\renewcommand{\binom}[2]{\scaleleftright[.7ex]{(}{\genfrac{}{}{0pt}{0}{#1}{#2}}{)}}
\newcommand{\parenthesis}[1]{\scaleleftright[.8ex]{(}{#1}{)}}
\newcommand{\curlybrace}[1]{\scaleleftright[.8ex]{\{}{#1}{\}}}
