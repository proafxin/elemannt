...
\else
	\setmainfont[FakeBold=2,BoldFont=BaskervilleF-Bold.otf,ItalicFont=ModernMT-ExtendedItalic.otf,BoldItalicFont=ModernMTStd-BoldItalic.otf,SmallCapsFont=OldStyleSeven-SC.otf]{ModernMT-Extended.otf}
	\setsansfont[%
...
\author{\textsc{\LARGE{Masum Billal}}}
