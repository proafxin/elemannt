...
\ifxetex
	...
	\setmathfont[range={it,"007D,frak,"2022,{up/Greek},{it/Greek}},Scale=\scale,FakeStretch=\fakestretch,FakeBold=\fakemathbold]{CenturymodernTT-Italic.otf}
	...
	\setmathfont{CenturymodernTT-Regular.otf}[range={bb,it/{num,"03BB},up/{num,"03BB},"00A7,"03BB,},Scale=\scale,FakeStretch=\fakestretch,FakeBold=\fakemathbold]
	...
	\setmathfont{IMFellEnglish-Regular.ttf}[range={"007B,"007D,},]
	\newfontfamily{\sumfont}{CenturymodernTT-Italic.ttf}[]% GFSSolomos.otf,lmroman17-regular.otf,lmromanslant17-regular.otf,Theano Didot Regular V1.otf
	\makeatletter
	...
	\newfontfamily{\prodfont}{CenturymodernTT-Italic.ttf}[FakeStretch=.9\fakestretch]%OldStandard-Italic.otf,ModernExtT-Theano.otf
	\makeatletter
	...
	\newfontfamily\intfont{CenturymodernTT-Regular.otf}[FakeBold=0]% OldStandard-Italic.otf,latinmodern-math.otf,Erewhon-Math.otf
	\makeatletter
...
\fancypagestyle{fancy}{
	...
	\fancyhead[CE]{\small\itshape Masum Billal}
	\fancyhead[R]{\thepage}
