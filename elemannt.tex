...
\begin{document}
	...
	\begin{titlepage}
		...
		{\fontsize{30}{10}\ E\hspace{.1em}L\hspace{.1em}E\hspace{.1em}M\hspace{.1em}E\hspace{.1em}N\hspace{.1em}T\hspace{.1em}A\hspace{.1em}R\hspace{.1em}Y\\\vspace{.3in} ANALYTIC\hspace{.3em}NUMBER\hspace{.3em} THEORY}\\[2\baselineskip]
		\ifxetex
			\scalebox{8}[1]{{\wb{10}{12}4}}
			\\[2\baselineskip]
		\fi
		{BY}\\[\baselineskip]
		{\fontsize{20}{10}\hspace{.5em} MASUM\hspace{.5em}BILLAL}\\[\baselineskip]
		\ifxetex
