\documentclass[lang=en,color=green,mode=fancy,math=cm,12pt,letterpaper]{elegantbook}
...
\begin{document}
	...
	\begin{titlepage}
		...
		\textit{Elementary Analytic Number Theory}\\ \vspace{.2in}
