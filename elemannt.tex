...
\ifxetex
	...
	\newfontfamily{\sumfont}{Theano Didot Regular V1.otf}[FakeBold=0]% GFSSolomos.otf,lmroman17-regular.otf,lmromanslant17-regular.otf
	\makeatletter
...
\usepackage[toc,nopostdot,automake=true,nonumberlist,order=word]{glossaries}
\usepackage{makeidx}
