...
\begin{document}
	...
	In this chapter, we will discuss some generalized arithmetic functions and their asymptotic behavior. We will skip discussing the basic definitions since they are common in most introductory number theory texts. But for the sake of completeness, check \gls{mobius} in \autoref{main}
	...
	This is a theorem\footnote{This is a theorem}. Now I am citing \textcite{apostol_1976}. See a proof by \gls{erdos}
\end{document}