	...
	Or consider the possibility that we can very easily deal with constants that would otherwise pop up here and there unnecessarily. With the help of $O$,
		\begin{align*}
			...
			O(cf(x))
				& = O(f(x))
		\end{align*}
	and so on. \textcite[Page 883]{landau_1909} states that the symbol $O$ had been first used by \textcite[Page 401]{bachmann_1894}. \textcite{hardy_riesz_1915} adopted the notations small $o$ and big $O$.
