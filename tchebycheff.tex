...
\begin{document}
	...
	Then he proved that if the limit
		...
		\end{align*}
	exists, then it is $1$. The only problem was it could not be proven that this limit indeed exists. The following proof is inspired by \textcite[Theorem 112]{landau_1969}. This book is actually a translation of the first section of the first volume of \textcite{landau_1927}.
		\begin{proof}
			For any $x\geq 0$,
				\begin{align*}
			...
			for a positive constant $a$. On the other hand, since $x<2+2\floor{\frac{x}{2}}$,
				\begin{align*}
					\pi(x)-\func{\pi}{\dfrac{x}{2}}
						...
						& < d\dfrac{x}{log{x}}
				\end{align*}
			for $\eta=\floor{\frac{x}{2}}$. Using $\func{\pi}{\frac{x}{2}}\leq\frac{x}{2}$,
				\begin{align*}
