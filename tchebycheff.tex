...
\begin{document}
	...
	\textcite{tschebischeff_1852} defines two functions that are today known as Tchebysceff's $\vartheta$ and $\psi$ functions.
		\begin{definition}[Tchebyscheff's $\vartheta$ function]\index{Tchebyscheff's $\vartheta$ function}
		...
		\begin{definition}[Tchebyscheff's $\psi$ function]\index{Tchebyscheff's $\psi$ function}
	...
	\section{Mertens' Theorems}\index{Mertens' Theorems}
